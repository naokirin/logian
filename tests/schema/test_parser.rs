...
pub fn test_parse_log_schema_with_user_defined_type() {
    let type_json = r#"{"comment":"comment", "fields":[{ "name": "field1", "type": "string" }]}"#;
    let log_json = r#"{"comment":"comment", "fields":[{ "name": "field1", "type": "user_defined_type" }]}"#;
    ...
    let expected_type = DataType::Struct("user_defined_type".to_string(), vec![field], "comment".to_string());
...
pub fn test_parse_user_defined_type() {
    ...
    if let DataType::Struct(name, fields, comment) = actual {
...
pub fn test_error_to_parse_log_schema_for_not_array() {
    let json = r#"{"comment": "", "fields": { "name": "field1", "type": "string" }}"#;
    let actual = parse_log_schema("log_name", json, &vec![]);
    assert_eq!("Fields is not an array: log_name.", actual.unwrap_err());
}

#[test]
pub fn test_error_to_parse_log_schema_for_no_string_type_name() {
    let json = r#"{"comment":"comment", "fields":[{ "name": "field1", "type": 1 }]}"#;
    let actual = parse_log_schema("log_name", json, &vec![]);
...
pub fn test_error_to_parse_log_schema_for_undefined_type() {
    let json = r#"{"comment":"", "fields":[{ "name": "field1", "type": "undefined_type" }]}"#;
    let actual = parse_log_schema("log_name", json, &vec![]);
...
pub fn test_error_to_parse_user_defined_schema_for_not_array() {
    ...
    assert_eq!("Fields is not an array: type_name.", actual.unwrap_err());
}

#[test]
pub fn test_error_to_parse_user_defined_type_for_no_string_type_name() {
    let json = r#"{"comment":"", "fields":[{ "name": "field1", "type": 1 }]}"#;
    let actual = parse_user_defined_type("type_name", json);
